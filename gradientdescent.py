...
def gradient_descent(X, y):
    ...
    for i in range(epochs):
        ...
        weights = weights - learning_rate * wd
        bias = bias - learning_rate * bd
        
        print(f"epoch {i}: weights {weights}, bias {bias:.4f}, cost {cost:.4f}")
        
    return weights, bias, cost_history

final_weights, final_bias, cost_history = gradient_descent(X_scaled, y_scaled)
